<?php
    ...
    echo '
        <div style="text-align: center;">
            ...
            <img src="/HCM/SimpleShop/user/forbidden.jpg" alt="Forbidden Access Auth" style="max-width: 300px; margin-bottom: 10px;">
            <br><br>
            <a href="/HCM/SimpleShop/index.php">Go to Home Page</a>
        </div>
    ';
